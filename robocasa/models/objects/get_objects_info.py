...
if __name__ == "__main__":
    ...
    for category, attributes in OBJ_CATEGORIES.items():
        types = attributes.get("types", [])
        if isinstance(types, tuple):
            all_object_types.update(types)

    all_object_types = list(all_object_types)

    path = "/ssd/home/groups/smartbot/huanghaifeng/robocasa_exps/robocasa/robocasa/models/objects/all_object_types.json" 
    with open(path, 'w') as json_files:
        json.dump(all_object_types, json_files, indent=4)       
