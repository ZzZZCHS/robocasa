...
SINGLE_STAGE_TASK_DATASETS = OrderedDict(
    PnPCounterToCab=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPCounterToCab.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPCounterToCab.hdf5",
        download_links=dict(
    ...
    PnPCabToCounter=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPCabToCounter.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPCabToCounter.hdf5",
        download_links=dict(
    ...
    PnPCounterToSink=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPCounterToSink.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPCounterToSink.hdf5",
        download_links=dict(
    ...
    PnPSinkToCounter=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPSinkToCounter.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPSinkToCounter.hdf5",
        download_links=dict(
    ...
    PnPCounterToMicrowave=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPCounterToMicrowave.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPCounterToMicrowave.hdf5",
        download_links=dict(
    ...
    PnPMicrowaveToCounter=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPMicrowaveToCounter.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPMicrowaveToCounter.hdf5",
        download_links=dict(
    ...
    PnPCounterToStove=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPCounterToStove.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPCounterToStove.hdf5",
        download_links=dict(
    ...
    PnPStoveToCounter=dict(
        ...
        addobj_path=f"v0.1/{data_version}/PnPStoveToCounter.hdf5",
        raw_path=f"v0.1/{raw_data_version}/PnPStoveToCounter.hdf5",
        download_links=dict(
    ...
    OpenSingleDoor=dict(
        ...
        addobj_path=f"v0.1/{data_version}/OpenSingleDoor.hdf5",
        raw_path=f"v0.1/{raw_data_version}/OpenSingleDoor.hdf5",
        download_links=dict(
    ...
    CloseSingleDoor=dict(
        ...
        addobj_path=f"v0.1/{data_version}/CloseSingleDoor.hdf5",
        raw_path=f"v0.1/{raw_data_version}/CloseSingleDoor.hdf5",
        download_links=dict(
    ...
    OpenDoubleDoor=dict(
        ...
        addobj_path=f"v0.1/{data_version}/OpenDoubleDoor.hdf5",
        raw_path=f"v0.1/{raw_data_version}/OpenDoubleDoor.hdf5",
        download_links=dict(
    ...
    CloseDoubleDoor=dict(
        ...
        addobj_path=f"v0.1/{data_version}/CloseDoubleDoor.hdf5",
        raw_path=f"v0.1/{raw_data_version}/CloseDoubleDoor.hdf5",
        download_links=dict(
    ...
    OpenDrawer=dict(
        ...
        addobj_path=f"v0.1/{data_version}/OpenDrawer.hdf5",
        raw_path=f"v0.1/{raw_data_version}/OpenDrawer.hdf5",
        download_links=dict(
    ...
    CloseDrawer=dict(
        ...
        addobj_path=f"v0.1/{data_version}/CloseDrawer.hdf5",
        raw_path=f"v0.1/{raw_data_version}/CloseDrawer.hdf5",
        download_links=dict(
    ...
    TurnOnSinkFaucet=dict(
        ...
        addobj_path=f"v0.1/{data_version}/TurnOnSinkFaucet.hdf5",
        raw_path=f"v0.1/{raw_data_version}/TurnOnSinkFaucet.hdf5",
        download_links=dict(
    ...
    TurnOffSinkFaucet=dict(
        ...
        addobj_path=f"v0.1/{data_version}/TurnOffSinkFaucet.hdf5",
        raw_path=f"v0.1/{raw_data_version}/TurnOffSinkFaucet.hdf5",
        download_links=dict(
    ...
    TurnSinkSpout=dict(
        ...
        addobj_path=f"v0.1/{data_version}/TurnSinkSpout.hdf5",
        raw_path=f"v0.1/{raw_data_version}/TurnSinkSpout.hdf5",
        download_links=dict(
    ...
    TurnOnStove=dict(
        ...
        addobj_path=f"v0.1/{data_version}/TurnOnStove.hdf5",
        raw_path=f"v0.1/{raw_data_version}/TurnOnStove.hdf5",
        download_links=dict(
    ...
    TurnOffStove=dict(
        ...
        addobj_path=f"v0.1/{data_version}/TurnOffStove.hdf5",
        raw_path=f"v0.1/{raw_data_version}/TurnOffStove.hdf5",
        download_links=dict(
    ...
    CoffeeSetupMug=dict(
        ...
        addobj_path=f"v0.1/{data_version}/CoffeeSetupMug.hdf5",
        raw_path=f"v0.1/{raw_data_version}/CoffeeSetupMug.hdf5",
        download_links=dict(
    ...
    CoffeeServeMug=dict(
        ...
        addobj_path=f"v0.1/{data_version}/CoffeeServeMug.hdf5",
        raw_path=f"v0.1/{raw_data_version}/CoffeeServeMug.hdf5",
        download_links=dict(
    ...
    CoffeePressButton=dict(
        ...
        addobj_path=f"v0.1/{data_version}/CoffeePressButton.hdf5",
        raw_path=f"v0.1/{raw_data_version}/CoffeePressButton.hdf5",
        download_links=dict(
    ...
    TurnOnMicrowave=dict(
        ...
        addobj_path=f"v0.1/{data_version}/TurnOnMicrowave.hdf5",
        raw_path=f"v0.1/{raw_data_version}/TurnOnMicrowave.hdf5",
        download_links=dict(
    ...
    TurnOffMicrowave=dict(
        ...
        addobj_path=f"v0.1/{data_version}/TurnOffMicrowave.hdf5",
        raw_path=f"v0.1/{raw_data_version}/TurnOffMicrowave.hdf5",
        download_links=dict(
...
def get_ds_path(task, ds_type, return_info=False):
    ...
    if ds_type == "human_raw":
        ...
        fname = "demo_gentex_im128_randcams.hdf5"
    elif ds_type == "addobj_im":
        folder = ds_config.get("addobj_path", None)
    elif ds_type == "raw_im":
        folder = ds_config.get("raw_path", None)
    else:
        raise ValueError
    ...
    if folder.endswith('.hdf5'):
        ds_path = os.path.join(ds_base_path, folder)
    else:
