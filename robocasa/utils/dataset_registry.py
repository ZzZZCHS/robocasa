...
SINGLE_STAGE_TASK_DATASETS = OrderedDict(
    PnPCounterToCab=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPCounterToCab.hdf5",
        download_links=dict(
    ...
    PnPCabToCounter=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPCabToCounter.hdf5",
        download_links=dict(
    ...
    PnPCounterToSink=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPCounterToSink.hdf5",
        download_links=dict(
    ...
    PnPSinkToCounter=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPSinkToCounter.hdf5",
        download_links=dict(
    ...
    PnPCounterToMicrowave=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPCounterToMicrowave.hdf5",
        download_links=dict(
    ...
    PnPMicrowaveToCounter=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPMicrowaveToCounter.hdf5",
        download_links=dict(
    ...
    PnPCounterToStove=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPCounterToStove.hdf5",
        download_links=dict(
    ...
    PnPStoveToCounter=dict(
        ...
        mg_path=f"v0.1/{data_version}/PnPStoveToCounter.hdf5",
        download_links=dict(
    ...
    OpenSingleDoor=dict(
        ...
        mg_path=f"v0.1/{data_version}/OpenSingleDoor.hdf5",
        download_links=dict(
    ...
    CloseSingleDoor=dict(
        ...
        mg_path=f"v0.1/{data_version}/CloseSingleDoor.hdf5",
        download_links=dict(
    ...
    OpenDoubleDoor=dict(
        ...
        mg_path=f"v0.1/{data_version}/OpenDoubleDoor.hdf5",
        download_links=dict(
    ...
    CloseDoubleDoor=dict(
        ...
        mg_path=f"v0.1/{data_version}/CloseDoubleDoor.hdf5",
        download_links=dict(
    ...
    OpenDrawer=dict(
        ...
        mg_path=f"v0.1/{data_version}/OpenDrawer.hdf5",
        download_links=dict(
    ...
    CloseDrawer=dict(
        ...
        mg_path=f"v0.1/{data_version}/CloseDrawer.hdf5",
        download_links=dict(
    ...
    TurnOnSinkFaucet=dict(
        ...
        mg_path=f"v0.1/{data_version}/TurnOnSinkFaucet.hdf5",
        download_links=dict(
    ...
    TurnOffSinkFaucet=dict(
        ...
        mg_path=f"v0.1/{data_version}/TurnOffSinkFaucet.hdf5",
        download_links=dict(
    ...
    TurnSinkSpout=dict(
        ...
        mg_path=f"v0.1/{data_version}/TurnSinkSpout.hdf5",
        download_links=dict(
    ...
    TurnOnStove=dict(
        ...
        mg_path=f"v0.1/{data_version}/TurnOnStove.hdf5",
        download_links=dict(
    ...
    TurnOffStove=dict(
        ...
        mg_path=f"v0.1/{data_version}/TurnOffStove.hdf5",
        download_links=dict(
    ...
    CoffeeSetupMug=dict(
        ...
        mg_path=f"v0.1/{data_version}/CoffeeSetupMug.hdf5",
        download_links=dict(
    ...
    CoffeeServeMug=dict(
        ...
        mg_path=f"v0.1/{data_version}/CoffeeServeMug.hdf5",
        download_links=dict(
    ...
    CoffeePressButton=dict(
        ...
        mg_path=f"v0.1/{data_version}/CoffeePressButton.hdf5",
        download_links=dict(
    ...
    TurnOnMicrowave=dict(
        ...
        mg_path=f"v0.1/{data_version}/TurnOnMicrowave.hdf5",
        download_links=dict(
    ...
    TurnOffMicrowave=dict(
        ...
        mg_path=f"v0.1/{data_version}/TurnOffMicrowave.hdf5",
        download_links=dict(
